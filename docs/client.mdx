...
```bash
go get github.com/dreamsxin/mcp-golang
```
...
For a complete working example, check out our [example client implementation](https://github.com/dreamsxin/mcp-golang/tree/main/examples/client).
